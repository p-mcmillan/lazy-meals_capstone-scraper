...
const scraperObjectFruitVegatables = {
  url: "https://www.yourindependentgrocer.ca/deals/all?sort=relevance&category=27985&category=28000",
  ...
  async scraper(browser) {
    ...
    for (const url of urls) {
      ...
      try {
        ...
        dataObj["item_category"] = "fruitsVegtables";
...
module.exports = scraperObjectFruitVegatables;
