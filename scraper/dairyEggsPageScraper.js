...
const scraperObjectDairyEggs = {
  url: "https://www.yourindependentgrocer.ca/deals/all?sort=relevance&category=27985&category=28003",
  ...
  async scraper(browser) {
    ...
    for (const url of urls) {
      ...
      try {
        ...
        dataObj["item_category"] = "DairyEggs";
...
module.exports = scraperObjectDairyEggs;
