...
const scraperObjectFrozen = {
  url: "https://www.yourindependentgrocer.ca/deals/all?sort=relevance&category=27985&category=28005",
  ...
  async scraper(browser) {
      ...
      try {
        ...
        try {
          ...
          if (originalPriceElement) {
            ...
            dataObj["item_original_price"] = "No original price";
          }

          ///SALE END DATE////
          const dateRegex = /\d{4}-\d{2}-\d{2}/;
          const match = expiryDateText.match(dateRegex);
          dataObj["saleExpiryDate"] = match ? match[0] : "No expiry date";
        } catch (error) {
          dataObj["item_sale_expiry_date"] = "No expiry date";
        }
        ////PRODUCT IMAGE////
    ...
    fs.readFile("frozen.json", "utf8", (err, data) => {
      if (err) {
...
module.exports = scraperObjectFrozen;
