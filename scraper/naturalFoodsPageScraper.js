...
const scraperObjectNaturalFoods = {
  url: "https://www.yourindependentgrocer.ca/deals/all?sort=relevance&category=27985&category=28189",
  ...
  async scraper(browser) {
    ...
    for (const url of urls) {
      ...
      try {
        ...
        dataObj["item_category"] = "naturalFoods";
...
module.exports = scraperObjectNaturalFoods;
