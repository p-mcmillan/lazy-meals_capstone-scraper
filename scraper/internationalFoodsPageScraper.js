...
const scraperObjectInternationalFoods = {
  url: "https://www.yourindependentgrocer.ca/deals/all?sort=relevance&category=27985&category=58044",
  ...
  async scraper(browser) {
    ...
    for (const url of urls) {
      ...
      try {
        ...
        dataObj["item_category"] = "internationalFoods";
...
module.exports = scraperObjectInternationalFoods;
