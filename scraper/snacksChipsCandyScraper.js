...
const scraperObjectSnacksChipsCandy = {
  url: "https://www.yourindependentgrocer.ca/deals/all?sort=relevance&category=27985&category=57025",
  ...
  async scraper(browser) {
    ...
    for (const url of urls) {
      ...
      try {
        ...
        dataObj["item_category"] = "snaksChipsCandy";
...
module.exports = scraperObjectSnacksChipsCandy;
